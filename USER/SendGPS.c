...
//-------------------------------------
 ...
 //--------------------------------------------------------------
  if(Degree==3)                                                //132
  {
	 GGB_Data[0] = (Angle)/100;	                                //°ÙÎ»    
   GGB_Data[1] = (Angle)/10    - ((uint16_t)GGB_Data[0])*10;   //Ê®Î»        
	 GGB_Data[2] = (Angle)       - ((uint16_t)GGB_Data[0])*100 - ((uint16_t)GGB_Data[1]*10) ;  //¸öÊý        		    
 ...
 //--------------------------------------------------------------		 								   
	...
	{
	 GGB_Data[0] = (Angle)/10;	                                //Ê®Î»    
   GGB_Data[1] = (Angle)    - ((uint16_t)GGB_Data[0])*10;     //¸öÎ»        	
...
void ProcessSSFTOA(double GGAIData,uint8_t bit)
{
 ...
 static uint64_t Anglel;
   ...
   if(bit==11)			       //bit==11
    ...
    GGS_Data[0] = (Anglel)/10000000000;	                              //Ç§Î»    	
    GGS_Data[1] = (Anglel)/1000000000  - ((uint32_t)GGS_Data[0]*10);     //°ÙÎ»        				                             //.
	  GGS_Data[2] = (Anglel)/100000000   - ((uint32_t)GGS_Data[0]*100)         - ((uint32_t)GGS_Data[1]*10) ;  //Ê®Êý        	
	  GGS_Data[3] = (Anglel)/10000000    - ((uint32_t)GGS_Data[0]*1000)        - ((uint32_t)GGS_Data[1]*100)        - ((uint32_t)GGS_Data[2]*10) ;  //Ê®Êý        	
		GGS_Data[4] = (Anglel)/1000000     - ((uint32_t)GGS_Data[0]*10000)       - ((uint32_t)GGS_Data[1]*1000)       - ((uint32_t)GGS_Data[2]*100)       - ((uint32_t)GGS_Data[3]*10) ;  //Ê®Êý        	
    GGS_Data[5] = (Anglel)/100000      - ((uint32_t)GGS_Data[0]*100000)      - ((uint32_t)GGS_Data[1]*10000)      - ((uint32_t)GGS_Data[2]*1000)      - ((uint32_t)GGS_Data[3]*100)     - ((uint32_t)GGS_Data[4]*10);  //Ê®Êý        	
		GGS_Data[6] = (Anglel)/10000       - ((uint32_t)GGS_Data[0]*1000000)     - ((uint32_t)GGS_Data[1]*100000)     - ((uint32_t)GGS_Data[2]*10000)     - ((uint32_t)GGS_Data[3]*1000)    - ((uint32_t)GGS_Data[4]*100)     - ((uint32_t)GGS_Data[5]*10);  //Ê®Êý        	
		GGS_Data[7] = (Anglel)/1000        - ((uint32_t)GGS_Data[0]*10000000)    - ((uint32_t)GGS_Data[1]*1000000)    - ((uint32_t)GGS_Data[2]*100000)    - ((uint32_t)GGS_Data[3]*10000)   - ((uint32_t)GGS_Data[4]*1000)    - ((uint32_t)GGS_Data[5]*100)    - ((uint32_t)GGS_Data[6]*10);  //Ê®Êý        	 
		GGS_Data[8] = (Anglel)/100         - ((uint32_t)GGS_Data[0]*100000000)   - ((uint32_t)GGS_Data[1]*10000000)   - ((uint32_t)GGS_Data[2]*1000000)   - ((uint32_t)GGS_Data[3]*100000)  - ((uint32_t)GGS_Data[4]*10000)   - ((uint32_t)GGS_Data[5]*1000)   - ((uint32_t)GGS_Data[6]*100)   - ((uint32_t)GGS_Data[7]*10);  //Ê®Êý        	  
		GGS_Data[9] = (Anglel)/10          - ((uint64_t)GGS_Data[0]*1000000000)  - ((uint64_t)GGS_Data[1]*100000000)  - ((uint32_t)GGS_Data[2]*10000000)  - ((uint32_t)GGS_Data[3]*1000000) - ((uint32_t)GGS_Data[4]*100000)  - ((uint32_t)GGS_Data[5]*10000)  - ((uint32_t)GGS_Data[6]*1000)  - ((uint32_t)GGS_Data[7]*100)  - ((uint32_t)GGS_Data[8]*10);  //Ê®Êý        	  
		GGS_Data[10]= (Anglel)             - ((uint64_t)GGS_Data[0]*10000000000) - ((uint64_t)GGS_Data[1]*1000000000) - ((uint32_t)GGS_Data[2]*100000000) - ((uint32_t)GGS_Data[3]*10000000)- ((uint32_t)GGS_Data[4]*1000000) - ((uint32_t)GGS_Data[5]*100000) - ((uint32_t)GGS_Data[6]*10000) - ((uint32_t)GGS_Data[7]*1000) - ((uint32_t)GGS_Data[8]*100)- ((uint32_t)GGS_Data[9]*10);  //Ê®Êý        	  
    ...
    GGS_Data[0] = (Anglel)/100000000;	                              //Ç§Î»    	
    GGS_Data[1] = (Anglel)/10000000  - ((uint32_t)GGS_Data[0]*10);     //°ÙÎ»        				                             //.
	  GGS_Data[2] = (Anglel)/1000000   - ((uint32_t)GGS_Data[0]*100)         - ((uint32_t)GGS_Data[1]*10) ;  //Ê®Êý        	
	  GGS_Data[3] = (Anglel)/100000    - ((uint32_t)GGS_Data[0]*1000)        - ((uint32_t)GGS_Data[1]*100)        - ((uint32_t)GGS_Data[2]*10) ;  //Ê®Êý        	
		GGS_Data[4] = (Anglel)/10000     - ((uint32_t)GGS_Data[0]*10000)       - ((uint32_t)GGS_Data[1]*1000)       - ((uint32_t)GGS_Data[2]*100)       - ((uint32_t)GGS_Data[3]*10) ;  //Ê®Êý        	
    GGS_Data[5] = (Anglel)/1000      - ((uint32_t)GGS_Data[0]*100000)      - ((uint32_t)GGS_Data[1]*10000)      - ((uint32_t)GGS_Data[2]*1000)      - ((uint32_t)GGS_Data[3]*100)     - ((uint32_t)GGS_Data[4]*10);  //Ê®Êý        	
		GGS_Data[6] = (Anglel)/100       - ((uint32_t)GGS_Data[0]*1000000)     - ((uint32_t)GGS_Data[1]*100000)     - ((uint32_t)GGS_Data[2]*10000)     - ((uint32_t)GGS_Data[3]*1000)    - ((uint32_t)GGS_Data[4]*100)     - ((uint32_t)GGS_Data[5]*10);  //Ê®Êý        	
		GGS_Data[7] = (Anglel)/10        - ((uint32_t)GGS_Data[0]*10000000)    - ((uint32_t)GGS_Data[1]*1000000)    - ((uint32_t)GGS_Data[2]*100000)    - ((uint32_t)GGS_Data[3]*10000)   - ((uint32_t)GGS_Data[4]*1000)    - ((uint32_t)GGS_Data[5]*100)    - ((uint32_t)GGS_Data[6]*10);  //Ê®Êý        	 
		GGS_Data[8] = (Anglel)           - ((uint32_t)GGS_Data[0]*100000000)   - ((uint32_t)GGS_Data[1]*10000000)   - ((uint32_t)GGS_Data[2]*1000000)   - ((uint32_t)GGS_Data[3]*100000)  - ((uint32_t)GGS_Data[4]*10000)   - ((uint32_t)GGS_Data[5]*1000)   - ((uint32_t)GGS_Data[6]*100)   - ((uint32_t)GGS_Data[7]*10);  //Ê®Êý        	  
   ...
   {
    GGS_Data[0] = (AngDot*10000)/1000;	                              //Ç§Î»    	
    GGS_Data[1] = (AngDot*10000)/100  - ((uint16_t)GGS_Data[0])*10;     //°ÙÎ»        				                             //.
	  GGS_Data[2] = (AngDot*10000)/10   - ((uint16_t)GGS_Data[0])*100 - ((uint16_t)GGS_Data[1]*10) ;  //Ê®Êý        	
	  GGS_Data[3] = (AngDot*10000)      - ((uint16_t)GGS_Data[0])*1000- ((uint16_t)GGS_Data[1]*100)- ((uint16_t)GGS_Data[2]*10) ;  //Ê®Êý        	
   ...
   {
    GGS_Data[0] = (AngDot*1000)/100;	                              //Ç§Î»    	
    GGS_Data[1] = (AngDot*1000)/10  - ((uint16_t)GGS_Data[0]*10);     //°ÙÎ»        				                             //.
...
//-------------------------------------
 ...
 //--------------------------------------------------------------
  if(Degree==4)                                                //132
  {
	 GGB_Data[0] = (Angle)/1000;	                                //Ç§Î»    
   GGB_Data[1] = (Angle)/100    - ((uint16_t)GGB_Data[0])*10;   //°ÙÎ»     
	 GGB_Data[2] = (Angle)/10     - ((uint16_t)GGB_Data[0])*100 -  ((uint16_t)GGB_Data[1]*10) ;  //Ê®Î»
   GGB_Data[3] = (Angle)        - ((uint16_t)GGB_Data[0])*1000 - ((uint16_t)GGB_Data[1]*100) -GGB_Data[2]*10;  //¸ö		
...
static   uint8_t  i;
   ...
   GGA_Data[0] = CheckNum/16 ; 			       //Ê®Î»
   GGA_Data[1] = CheckNum -GGA_Data[0]*16;	   //¸öÎ»
...
uint8_t ProcessATOA(uint16_t GGAIData)
{
 ...
 if(Degree==3)                                                 //132
	{
	  GGB_Data[0] = (GGAIData)/100;	                                //°ÙÎ»    
    GGB_Data[1] = (GGAIData)/10    - ((uint16_t)GGB_Data[0])*10;    //Ê®Î»        
	  GGB_Data[2] = (GGAIData)       - ((uint16_t)GGB_Data[0])*100 - ((uint16_t)GGB_Data[1]*10) ;  //¸öÊý        	
	...
	{
	  GGB_Data[0] = (GGAIData)/10;	                           //Ê®Î»    
    GGB_Data[1] = (GGAIData)    -  GGB_Data[0]*10;   //¸öÎ»        
...
//-------------------------------------
 ...
 //--------------------------------------------------------------  
   if(bit==2)	   				                       //"Á½Î»Êý×Ö" + "." = "ÈýÎ»"
   {
	...
	{
	  GGA_Data[0] = '0';	                               //°ÙÎ»    						          //.																	  	
    GGA_Data[1] = (GGAIData)/10;	                   //Ê®Î»    						          //.
    GGA_Data[2] = (GGAIData)    - ((uint16_t)GGA_Data[0])*10;  //¸öÎ»  		
	...
	{
    GGA_Data[0] = (GGAIData*10)/10;	                               //Ê®Î»
    GGA_Data[1] = 0x2E;						                       //.
    GGA_Data[2] = (GGAIData*10)    - ((uint16_t)GGA_Data[0])*10;   //¸öÎ»  
...
//--------------------------------------------------------------
   else	 if(bit==3)									              //"ÈýÎ»Êý×Ö" + "." = "ËÄÎ»"
   {
    if(Degree==3)                                                 //132==>132==>132
	{
	  GGA_Data[0] = (GGAIData)/100;	                                //°ÙÎ»    
    GGA_Data[1] = (GGAIData)/10    - ((uint16_t)GGA_Data[0])*10;    //Ê®Î»        
	  GGA_Data[2] = (GGAIData)       - ((uint16_t)GGA_Data[0])*100 - ((uint16_t)GGA_Data[1]*10) ;  //¸öÊý        	
	  GGA_Data[3] = 0x2E;						                          //.
	...
	{
	  GGA_Data[0] = (GGAIData*10)/100;	                              //Ê®Î»    
    GGA_Data[1] = (GGAIData*10)/10    - ((uint16_t)GGA_Data[0])*10;   //¸öÎ»        
	  GGA_Data[2] = 0x2E;						                          //.
	  GGA_Data[3] = (GGAIData*10)       - ((uint16_t)GGA_Data[0])*100 - ((uint16_t)GGA_Data[1]*10) ;  //Ð¡Êý        	
	...
	{
    GGA_Data[0] = (GGAIData*100)/100;	                              //¸öÎ»
    GGA_Data[1] = 0x2E;						                          //.
    GGA_Data[2] = (GGAIData*100)/10    - ((uint16_t)GGA_Data[0])*10;  //Ð¡Î»        
	  GGA_Data[3] = (GGAIData*100)       - ((uint16_t)GGA_Data[0])*100 - ((uint16_t)GGA_Data[2])*10 ;  //Ð¡Î»        
...
//--------------------------------------------------------------
   else	if(bit==4)									                  //"ËÄÎ»Êý×Ö" + "." = "ÎåÎ»"
   {
    if(Degree==4)                                                     //1321==>1321==>1321.
  	{
	  GGA_Data[0] = (GGAIData)/1000;	                                  //Ç§Î»    
    GGA_Data[1] = (GGAIData)/100  - ((uint16_t)GGA_Data[0])*10;       //°ÙÎ»        
	  GGA_Data[2] = (GGAIData)/10   - ((uint16_t)GGA_Data[0])*100 - ((uint16_t)GGA_Data[1]*10) ;  //Ê®Êý        	
	  GGA_Data[3] = (GGAIData)      - ((uint16_t)GGA_Data[0])*1000- ((uint16_t)GGA_Data[1]*100)- ((uint16_t)GGA_Data[2]*10) ;  //Ê®Êý        	
	  GGA_Data[4] = 0x2E;						                          //.
    ...
    GGA_Data[2] = GGA_Data[2] + 0x30;       
	  ...
	  {
    GGA_Data[0] = (GGAIData*10)/1000;	                                 //Ç§Î»    
    GGA_Data[1] = (GGAIData*10)/100  - ((uint16_t)GGA_Data[0])*10;       //°ÙÎ»        
	  GGA_Data[2] = (GGAIData*10)/10   - ((uint16_t)GGA_Data[0])*100 - ((uint16_t)GGA_Data[1]*10) ;  //Ê®Êý        	
	  GGA_Data[3] = 0x2E;						                             //.
    ...
    GGA_Data[2] = GGA_Data[2] + 0x30;       
	 ...
	 {
    GGA_Data[0] = (GGAIData*100)/1000;	                                 //Ç§Î»    
    GGA_Data[1] = (GGAIData*100)/100  - ((uint16_t)GGA_Data[0])*10;      //°ÙÎ»        
	  GGA_Data[2] = 0x2E;						                             //.
	  GGA_Data[3] = (GGAIData*100)/10   - ((uint16_t)GGA_Data[0])*100 - ((uint16_t)GGA_Data[1]*10) ;  //Ê®Êý        	
	  GGA_Data[4] = (GGAIData*100)      - ((uint16_t)GGA_Data[0])*1000- ((uint16_t)GGA_Data[1]*100)- ((uint16_t)GGA_Data[3]*10) ;  //Ê®Êý        	
    ...
    GGA_Data[3] = GGA_Data[3] + 0x30;       
	 ...
	 {																											
    GGA_Data[0] = (GGAIData*1000)/1000;	                                 //Ç§Î»    
	  GGA_Data[1] = 0x2E;													 //.
    GGA_Data[2] = (GGAIData*1000)/100  - ((uint16_t)GGA_Data[0])*10;     //°ÙÎ»        				                             //.
	  GGA_Data[3] = (GGAIData*1000)/10   - ((uint16_t)GGA_Data[0])*100 - ((uint16_t)GGA_Data[2]*10) ;  //Ê®Êý        	
	  GGA_Data[4] = (GGAIData*1000)      - ((uint16_t)GGA_Data[0])*1000- ((uint16_t)GGA_Data[2]*100)- ((uint16_t)GGA_Data[3]*10) ;  //Ê®Êý        	
...
{									
 static  uint8_t  i;
   ...
   GGA_Data[0] = GGAIData/10 ;				   //Ê®Î»
   GGA_Data[1] = GGAIData -GGA_Data[0]*10;	   //¸öÎ»
...
//-------------------------------------
 ...
 //--------------------------------------------------------------  
    ...
    GGA_Data[1] = (GGAIData)/1000  - ((uint16_t)GGA_Data[0])*10;        
	  GGA_Data[2] = (GGAIData)/100   - ((uint16_t)GGA_Data[0])*100 -  ((uint16_t)GGA_Data[1]*10) ;  //Ê®Êý        	
	  GGA_Data[3] = (GGAIData)/10    - ((uint16_t)GGA_Data[0])*1000-  ((uint16_t)GGA_Data[1]*100) - ((uint16_t)GGA_Data[2]*10) ;  //Ê®Êý        	
    GGA_Data[4] = (GGAIData)       - ((uint16_t)GGA_Data[0])*10000- ((uint16_t)GGA_Data[1]*1000)- ((uint16_t)GGA_Data[2]*100) -((uint16_t)GGA_Data[3]*10) ;  //Ê®Êý         
	  }	 	
 ...
 static  uint8_t  i,Len;
	 ...
	 else
	 {
	   if(GGAIData<-99)
		 ...
		 GGA_Data[1] = GGAIData/10 ;				   //Ê®Î»
		 GGA_Data[2] = GGAIData -GGA_Data[1]*10;	   //¸öÎ»
...
{									
 static  uint8_t  i;
   ...
   GGA_Data[0] = GGAIData/1000 ;				   //Ê®Î»
   GGA_Data[1] = GGAIData/100 - GGA_Data[0]*10;	   //¸öÎ»
   GGA_Data[2] = GGAIData/10  - GGA_Data[0]*100  - GGA_Data[1]*10;	   //¸öÎ»
	 GGA_Data[3] = GGAIData     - GGA_Data[0]*1000 - GGA_Data[1]*100 - GGA_Data[2]*10;	   //¸öÎ»
...
//	 }
	...
	//---------------------------------
	 if (!IS_INS_ALIGNED(g_GINavInfo.INSState)) 
		...
		else                                 //´Ë´¦²»ºÏÀí£¬-102.2==>-102 ËùÒÔÓ¦¸ÃÊÇ¶¯Ì¬....
		{
		 Tra_Data[0]= '-';
	...
	//±£´æRMCÊý¾Ýµ½sinRingBuf
	 printf( "RMC_TX_DATA \n");
	 rec_sai_fifo_write(RMC_TX_DATA,RMC_TX_Max-1);
		
//	 	HAL_UART_Transmit_DMA(&UART1_Handler,RMC_TX_DATA,RMC_TX_Max);//¿ªÆôDMA´«Êä
//		
//	 	while(1)
//		{
//        if(__HAL_DMA_GET_FLAG(&UART1TxDMA_Handler,DMA_FLAG_TCIF3_7))//µÈ´ýDMA2_Steam7´«ÊäÍê³É
//        {
//           __HAL_DMA_CLEAR_FLAG(&UART1TxDMA_Handler,DMA_FLAG_TCIF3_7);//Çå³ýDMA2_Steam7´«ÊäÍê³É±êÖ¾
...
extern uint8_t IMUTime_Data[10];
...
//	 }
	...
	//--------------------------------
		...
		UTC_Data[8] = GGA_Data[1];	//8
		//if(pps_get_flag)
	  //memcpy(IMUTime_Data,UTC_Data,10);
...
//		GGA_UP_Num=100;
	...
	//--------------------------------------------------
	 ...
	 //-------------------------------------- 
		...
		CheckNumData    = ProcessCheckResult(0,79);
		ProcessCheckToA(CheckNumData);
	 ...
	 //---------------------------------------
		...
		GpsGet_Data.GGA_Get_Flag = 1;
		printf("GGA_TX_DATA\n");
		//½«IMUÊý¾Ý±£´æÖÁSD¿
		rec_sai_fifo_write(GGA_TX_DATA,GGA_TX_Max-1);


		
//	 	HAL_UART_Transmit_DMA(&UART1_Handler,GGA_TX_DATA,GGA_TX_Max);//¿ªÆôDMA´«Êä
